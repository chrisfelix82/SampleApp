...
], function(dojo_declare, dojo_lang, dojo_array, dojo_window, dojo_html, dojo_event, dojo_connect, dojo_keys, dojo_dnd_Moveable, dojo_touch, dijit_registry, dijit_layout_TabContainer, dijit_layout_TabController, dijit_layout_ScrollingTabController, dijit_layout_ContentPane){
 ...
 */
var MoveableTabController = dojo_declare("idx.layout.MoveableTabController", [dijit_layout_ScrollingTabController],
 ...
 */
var MoveableTabButton = dojo_declare("idx.layout.MoveableTabButton", [dijit_layout_TabController.TabButton],
/**@lends idx.layout.MoveableTabButton#*/
{
	...
	postCreate: function() {
		...
		this.connect(this.focusNode, dojo_touch.press, "_onTabMouseDown");
	},
	...
	_onTabMouseDown: function(evt) {
		...
		this._moveConnects = [
             this.connect(dojo_window.body(), dojo_touch.move, "_onTabMouseMove"),
             this.connect(dojo_window.body(), dojo_touch.release, "_onTabMouseUp")
        ];
	},
...
MoveableTabContainer.MoveableTabController = MoveableTabController;
MoveableTabContainer.MoveableTabButton = MoveableTabButton;
