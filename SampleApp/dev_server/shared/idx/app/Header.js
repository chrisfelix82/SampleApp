			...
			require(modules, function(){
				...
				if(show_primary_items){
					me._injectTemplate(me._mainContainerNode,
										 ...
										 '<ul class="idxHeaderPrimaryActionsLeading" data-dojo-attach-point="_leadingGlobalActionsNode" role="menubar">' +
										 '</ul>' +
										 '<ul class="idxHeaderPrimaryActionsTrailing" data-dojo-attach-point="_trailingGlobalActionsNode" role="menubar">' +
										 '</ul>' +
										 '</div>' +
										 '</div>');
				}
