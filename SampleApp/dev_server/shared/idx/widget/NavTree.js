...
define(["dojo/_base/declare",						// dDeclare
        ...
        "dojo/dom-construct",						// dDomConstruct
		"dijit/Tree",								// dTree
		"../util",									// iUtil
				 ...
				 nodeTemplateText)	// (dojo/text!./templates/NavTreeNode.html)
{
		...
		/**
 		 ...
 		 * @class Widget for sidebar navigation via a tree control.  This adds badges,
 		 *        selectability, node types and other features to the basic dijit Tree.
 		 * @augments dijit.Tree
 		 */
			...
			/** @lends idx.widget.NavTree# */
		{
			...
			/**
			 * Handler for the "highlightSelection" attribute setting.  This updates the
			 * CSS class of the widget to ensure the proper highlighting effect is achieved.
			 * 
			 */
			...
			/**
			 * Override to fire the _onSelectionChanged event when needed.
			 */
			_setPathsAttr: function(value) {
				if (! this._started) return this.inherited(arguments);
				var previous = this.dndController.getSelectedTreeNodes();
				var promise = this.inherited(arguments);
				promise.then(dLang.hitch(this, function() {
					var current = this.dndController.getSelectedTreeNodes();
			...
			/**
			 * Method to ensure item labels are updated when resources change.
			 */
			...
			/**
			 * Method to ensure badge labels are updated when resources change.
			 */
			...
			/**
			 * Method to ensure badge icon labels are updated when resources change.
			 */
			...
			/**
			 * Private method to handle creating a new tree node.
			 * @private
			 */
